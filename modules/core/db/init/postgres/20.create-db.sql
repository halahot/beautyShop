...
alter table BEAUTYSHOP_PRODUCT add constraint FK_BEAUTYSHOP_PRODUCT_ORDER foreign key (ORDER_ID) references BEAUTYSHOP_ORDER(ID)^
...
create index IDX_BEAUTYSHOP_PRODUCT_ORDER on BEAUTYSHOP_PRODUCT (ORDER_ID)^
