...
alter table BEAUTYSHOP_PRODUCT add constraint FK_BEAUTYSHOP_PRODUCT_BRANDS foreign key (BRANDS_ID) references BEAUTYSHOP_BRAND(ID)^
...
create index IDX_BEAUTYSHOP_PRODUCT_BRANDS on BEAUTYSHOP_PRODUCT (BRANDS_ID)^
